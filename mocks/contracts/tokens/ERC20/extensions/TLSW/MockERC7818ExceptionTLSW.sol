...
contract MockERC7818ExceptionTLSW is ERC20EXPBase, ERC7818Exception {
    constructor(
        string memory _name,
    ...
    function balanceOf(address account) public view virtual override(ERC20EXPBase, ERC7818Exception) returns (uint256) {
        return super.balanceOf(account);
    }

    function transfer(address to, uint256 value) public virtual override(ERC20EXPBase, ERC7818Exception) returns (bool) {
        return super.transfer(to, value);
    }

    function transferFrom(address from, address to, uint256 value) public virtual override(ERC20EXPBase, ERC7818Exception) returns (bool) {
    ...
    function transferAtEpoch(
        ...
        address to,
        uint256 value
    ) public virtual override(ERC20EXPBase, ERC7818Exception) returns (bool) {
