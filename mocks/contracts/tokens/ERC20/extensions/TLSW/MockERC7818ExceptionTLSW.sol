...
contract MockERC7818ExceptionTLSW is ERC7818, ERC7818Exception {
    constructor(
        string memory _name,
        string memory _symbol,
        uint40 secondsPerEpoch_,
        uint8 windowSize_
    ) ERC7818(_name, _symbol, block.timestamp, secondsPerEpoch_, windowSize_, false) {}
    ...
    function balanceOf(address account) public view virtual override(ERC7818, ERC7818Exception) returns (uint256) {
        return super.balanceOf(account);
    }

    function transfer(address to, uint256 value) public virtual override(ERC7818, ERC7818Exception) returns (bool) {
        return super.transfer(to, value);
    }

    function transferFrom(address from, address to, uint256 value) public virtual override(ERC7818, ERC7818Exception) returns (bool) {
        return super.transferFrom(from, to, value);
    }

    function transferAtEpoch(uint256 epoch, address to, uint256 value) public virtual override(ERC7818, ERC7818Exception) returns (bool) {
    ...
    function transferFromAtEpoch(
        ...
        address to,
        uint256 value
    ) public virtual override(ERC7818, ERC7818Exception) returns (bool) {
