...
abstract contract SlidingWindow is ISlidingWindow {
    ...
    function _updateSlidingWindow(uint24 blockTime, uint8 frameSize, uint8 slotSize) internal {
    ...
    function _getSlotPerEra() internal view returns (uint8) {
    ...
    /// @inheritdoc ISlidingWindow
    function getSlotPerEra() external view override returns (uint8) {
