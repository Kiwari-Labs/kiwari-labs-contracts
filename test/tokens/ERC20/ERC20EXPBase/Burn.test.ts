...
export const run = async () => {
  describe("Burn", async function () {
    it("[HAPPY] burn correctly if mint tokens into slot 0, 1 of epoch 0", async function () {
      // Start at block 100.
    ...
    it("[HAPPY] burn correctly if mint tokens into slot 1, 2 of epoch 0", async function () {
      // Start at block 100.
      const startBlockNumber = 100;
    ...
    it("[HAPPY] burn correctly if mint tokens into slot 2, 3 of epoch 0", async function () {
      // Start at block 100.
      const startBlockNumber = 100;
    ...
    it("[HAPPY] burn correctly if mint tokens into slot 0, 1 of epoch 0 when frame size full epoch", async function () {
      // Start at block 100.
      const startBlockNumber = 100;
    ...
    it("[HAPPY] burn correctly if mint tokens into slot 1, 2 of epoch 0 when frame size full epoch", async function () {
      // Start at block 100.
      const startBlockNumber = 100;
    ...
    it("[HAPPY] burn correctly if mint tokens into slot 2, 3 of epoch 0 when frame size full epoch", async function () {
      // Start at block 100.
      const startBlockNumber = 100;
    ...
    it("[HAPPY] burn correctly if mint tokens into slot 0, 1 of epoch 0 when frame size over epoch", async function () {
      // Start at block 100.
      const startBlockNumber = 100;
    ...
    it("[HAPPY] burn correctly if mint tokens into slot 1, 2 of epoch 0 when frame size over epoch", async function () {
      // Start at block 100.
      const startBlockNumber = 100;
    ...
    it("[HAPPY] burn correctly if mint tokens into slot 2, 3 of epoch 0 when frame size over epoch", async function () {
      // Start at block 100.
      const startBlockNumber = 100;
    ...
    it("[HAPPY] burn correctly if mint mint at end epoch period", async function () {
      // Start at block 100.
      const startBlockNumber = 100;
