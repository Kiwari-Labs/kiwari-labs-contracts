...
export const run = async () => {
  describe("CalculationSafeFrame", async function () {
    it("[SUCCESS] calculate correctly safe frame if the current block is in the first slot period of the first epoch", async function () {
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the second slot period of the first epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the third slot period of the first epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the fourth slot period of the first epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the first slot period of the second epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the second slot period of the second epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the third slot period of the second epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the fourth slot period of the second epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the first slot period of the third epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the second slot period of the third epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the third slot period of the third epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if the current block is in the fourth slot period of the third epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 2;
    ...
    it("[SUCCESS] calculate correctly safe frame if frame size equal to 3 and slot size equal to 4", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 3;
    ...
    it("[SUCCESS] calculate correctly safe frame if frame size equal to 3 and slot size equal to 4 when the frame is in between both epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 3;
    ...
    it("[SUCCESS] calculate correctly safe frame if frame size equal to slot size", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 4;
    ...
    it("[SUCCESS] calculate correctly safe frame if frame size equal to slot size when the frame is in between both epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 4;
    ...
    it("[SUCCESS] calculate correctly safe frame if frame size equal to 5 and slot size equal to 4", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 5;
    ...
    it("[SUCCESS] calculate correctly safe frame if frame size equal to 5 and slot size equal to 4 when the current block is in third epoch", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 4;
      const frameSize = 5;
    ...
    it("[SUCCESS] calculate correctly safe frame if frame size equal to 3 and slot size equal to 5", async function () {
      const startBlockNumber = 100;
      const blockPeriod = 400;
      const slotSize = 5;
      const frameSize = 3;
    ...
    // it("[SUCCESS] calculate correctly safe frame if the current block is in the last day period of the first epoch", async function () {
    //   const startBlockNumber = 100;
    //   const blockPeriod = 400;
    //   const slotSize = 4;
    //   const frameSize = 2;
    ...
    // it("[SUCCESS] calculate correctly safe frame if the current block is in the first day period of the second epoch", async function () {
    //   const startBlockNumber = 100;
    //   const blockPeriod = 400;
    //   const slotSize = 4;
    //   const frameSize = 2;
